...
// Mantine `onConfirm` types as `() => void`; this wrapper voids the promise so
// `no-misused-promises` stops flagging async confirm handlers.
function asyncOnConfirm(handler: () => Promise<unknown>): () => void {
  return () => {
    void handler();
  };
}
...
export default function ConfigurationDetailPage() {
  ...
  function openRestartFleetConfirm() {
    modals.openConfirmModal({
      ...
      onConfirm: asyncOnConfirm(async () => {
