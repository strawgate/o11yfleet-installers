/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fbaacbaac7417adea7b3e3de5106fa2a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLAIM_SECRET">> {}
}
